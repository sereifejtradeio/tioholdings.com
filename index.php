...
<head>
    ...
    <meta name="google-site-verification" content="u8paYM47iVfpZ3T8r4ihHpf2ZAYy793-8gEUVYqxjEI" />
...
<!--                        We are a marketing and front-end development company which offers specialist digital marketing services, via its headquarters in Limassol, Cyprus.-->
            ...
            <div class="row text-white mb-3">
                ...
                <div class="col-lg-3 mb-3 text-center">
                    <div class="card-transparent">
                        <img class="card-img-top" src="images/graphic-design-icon.png" alt="" />
                        <div class="card-body">
...
<!--                    <a href="#" class="btn btn-secondary">Contact us</a>-->
    ...
    <section id="clients">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 clients-images">
                    <a href="https://tiomarkets.com" target="_blank"><img src="images/tiomarkets-image-logo.jpg" class="img-fluid" title="Visit Tio Markets" alt="Tio Markets"></a>
                </div>
                <div class="col-md-6 clients-images">
                    <a href="https://trade.io" target="_blank"><img src="images/tradeio-image-logo.jpg" class="img-fluid" title="Visit Trade Io" alt="Trade Io"></a>
                </div>
            </div>
<!--            <div class="col-md-12 text-center align-items-center justify-content-center mt-5 text-white">-->
<!--                <a href="#" id="clients-button"  class="btn btn-secondary">Become a Client</a>-->
<!--            </div>-->
